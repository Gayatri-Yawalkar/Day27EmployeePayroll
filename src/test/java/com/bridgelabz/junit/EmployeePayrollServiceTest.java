...
public class EmployeePayrollServiceTest {
	@Test
	public void given3Employees_whenWrittenToFile_should_MatchEmployeeCount() {
	...
	@Test
	public void givenFile_onReadingFile_shouldMatchEmployeeCount() {
		EmployeePayrollService employeePayrollService=new EmployeePayrollService(Arrays.asList());
